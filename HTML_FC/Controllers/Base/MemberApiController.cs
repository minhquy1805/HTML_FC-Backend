...
namespace HTML_FC.ApiControllers
{
    ...
    public partial class MemberApiController : ControllerBase
    {
        ...
        {
            List<Member> members = await _memberBusinessLayer.SelectAllDynamicWhereAsync(memberId, firstName, middleName, lastName, phone, email, facebook, address, type, avatar, numberPlayer, role, username, password, field1, field2, field3, field4, field5, createdAt, flag);
            return members;
        }
    }
}
